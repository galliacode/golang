...
const getData = async token => {
	...
	const data = await Axios.get(`${process.env.NEXT_PUBLIC_MONI_API}/api/agent/auth`, header);
	return data.data;
};
...
const getUserCount = async token => {
	...
	const data = await Axios.get(`${process.env.NEXT_PUBLIC_MONI_API}/api/users/count`, header);
	return data.data;
};
...
const agentStatusChange = async (token, id, status) => {
	...
	const url = `${process.env.NEXT_PUBLIC_MONI_API}/api/agent/` + stat + '/' + id;
...
const get_all_transactions = async (token, page, limit) => {
	...
	const res = await Axios.get(
		`${process.env.NEXT_PUBLIC_MONI_API}/api/operations` + '?page=' + page + '&limit=' + limit,
		header
	);
	return res.data;
};
...
const get_agent_transactions = async (token, id, page, limit) => {
	...
	const res = await Axios.get(
		`${process.env.NEXT_PUBLIC_MONI_API}/api/operations/agent/` +
		id +
		'?page=' +
		page +
		'&limit=' +
...
const get_admin_commission = async token => {
	...
	const res = await Axios.get(
		`${process.env.NEXT_PUBLIC_MONI_API}/api/operations/commission/admin`,
		header
	);
	return res.data;
};
...
const get_agent_commission = async (token, id) => {
	...
	const res = await Axios.get(
		`${process.env.NEXT_PUBLIC_MONI_API}/api/operations/commission/agent/` + id,
		header
	);
	return res.data;
};
